...
def forgotten_land():
    ...
    time.sleep(0.5)
    print(" \n")
    print("you have gained a HP buff")
    typewriter("Ohh great! Look what we have disturbed on entry!!\n")
    typewriter("Sephiroth is the key for use to leave this realm we need to defeat hime to escape")
    print(" \n")
    print("BANG")
    typewriter("NO HE'S HERE ATTACK HIM NOW!!!!")
    time.sleep(0.5)
    player.set_health (300)
    monster1.set_health(400)
    monster_option = 3
    monster1 = enemy_gen() 
    first_fight()
    time.sleep(1)
...
print(" \n")
print(" \n")
Character_Name = input("Choose Your Characters Name: ").capitalize()
time.sleep(1)
print(" \n")
...
def enemy_gen():
    ...
    if monster_option == 1:
        ...
        return monster("Sephiroth", 400 , 50 )
...
def la_fight():
    ...
    if downtown_mutant.lower() == "a":
        ...
        time.sleep(0.5)
        typewriter("You follow to see where it will lead you, now that you have created some distance between you and the mutant\n")
        time.sleep(0.5)
