...
#Health bar monster
def do_enemy1_health(background_colour, background_colour_end):
...
player = choose_class()
monster1 = monster("sephiroth", 200, 30 )
...
def jungle_fight():
    while active:
        ...
        if temple_guardian == "A" or temple_guardian == "a":
                ...
                time.sleep(0.5)
                continue
        while temple_guardian != "r" and temple_guardian != "a":
