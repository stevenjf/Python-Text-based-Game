...
def portal():
    print("you have been granted acsess to the portal")
...
def choose_class():
    ...
    if option == 1:
        ...
        return player(Character_Name, 200 , 30 , 50, 90)
    elif option == 3:
        class_chosen = "Reaper"
        return player(Character_Name, 200 , 20 , 40 , 60)
...
def player_hit():
    ...
    if rand_num in [1, 2, 3,]:
        typewriter(f"You Are Being Attacked...\n 1 = {abilities[0]}\n 2 = {abilities[1]}\n 3 = {abilities[2]}\n ")
        var = input()
        if var == "1":
            print (var)
...
def riddle():
    ...
    riddle_one = "What is full of holes but still holds water?"
    riddle_two = "What month of the year has 28 days?"
    riddle_three = "What goes up but never comes down?"
    print("To get past me you must answer this riddle...")
...
D.  An Old Backpack
        ...
        if answer == "b":
            ...
            print("Incorrect! You shall face your doom!")
            time.sleep(3.0)
            monster_option = 2
            monster1 = enemy_gen
            first_fight()
...
D.  All of Them
        ''')
        answer = input("Your answer2: ").lower()
        if answer == "d":
            print(f"You answered: {answer}....")
            time.sleep(2.0)
            print("Your right!")
...
D.  A Jumping Kangaroo
        ''')
    answer = input("Your answer3: ").lower()
    if answer == "c":
        print(f"You answered: {answer}....")
        time.sleep(2.0)
        print("Your right!")
